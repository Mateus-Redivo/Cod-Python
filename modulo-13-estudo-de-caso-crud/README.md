...
1. [EXERCICIO-01-mapeando-o-sistema.md](exercicios/EXERCICIO-01-mapeando-o-sistema.md) —
   *nível 1*: usar, mapear e rastrear uma operação.
2. [EXERCICIO-02-estendendo-o-sistema.md](exercicios/EXERCICIO-02-estendendo-o-sistema.md) —
   *nível 2*: acrescentar funcionalidades sem quebrar o que existe.
3. [EXERCICIO-03-auditoria-do-sistema.md](exercicios/EXERCICIO-03-auditoria-do-sistema.md) —
   *nível 3*: encontrar os defeitos de um sistema que funciona.
