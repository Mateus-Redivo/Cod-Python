...
1. **descricoes_receitas[]** - Armazena descrições das receitas
2. **valores_receitas[]** - Armazena valores das receitas
3. **descricoes_despesas[]** - Armazena descrições das despesas
4. **valores_despesas[]** - Armazena valores das despesas
