...
| --- | --- | --- |
| E1 | Direito (primeira mesa após a porta) | Batalha com Ness |
| E2 | Esquerdo | Quiz da Floresta |
| E3 | Direito | Kelpie |
| E4 | Esquerdo | Poção Mágica I |
| E5 | Direito | Nuckelavee |
| E6 | Fundo do corredor (mesa final, atravessada) | Poção Mágica II |

## Quadro de grupos e horários

| Estação | Tipo | Estação (tema) | Grupo responsável |
| --- | --- | --- | --- |
| E1 | Físico | Batalha com Ness | Grupo 4 |
| E2 | Python | Quiz da Floresta | Grupo 1 |
| E3 | Físico | Kelpie | Grupo 6 |
| E4 | Python | Poção Mágica I | Grupo 2 |
| E5 | Físico | Nuckelavee | |
| E6 | Python | Poção Mágica II | Grupo 3 |
...
## Estação 1 · Físico · Batalha com Ness
...
**Personagem do grupo:** um integrante narra como arauto da batalha.

**Material:** 1 dado de 6 faces + 1 ficha com a regra.
...
## Estação 2 · Python · Quiz da Floresta
...
**Material:** computador com o programa `sala_b_e2_quiz.py`. Sem material impresso.

**Roteiro de apresentação:**

1. **Abertura:** "Três perguntas sobre as lendas escocesas separam você da resposta certa."
2. **Condução:** deixe o visitante responder as 3 perguntas no programa.
3. **Se acertar 2 de 3:** "Você conhece bem essas lendas! Senha: **LAGOBEANS**."
4. **Se errar demais:** dê a resposta certa com bom humor e siga em frente.

**Senha liberada: `LAGOBEANS`**

---

## Estação 3 · Físico · Kelpie
...
**Material:** 1 ficha impressa + 1 envelope fechado com a senha.
...
## Estação 4 · Python · Poção Mágica I
...
**Material:** computador com o programa `sala_b_e4_pocao1.py`. Sem material impresso.
...
**Material:** fita crepe no chão (simulando uma ponte estreita) + 1 ficha impressa.
...
## Estação 6 · Python · Poção Mágica II (estação final da Sala B)
...
**Material:** computador com o programa `sala_b_e6_pocao2.py`. Sem material impresso.
